	...
	descriptions = {
		...
		Joker = {
			...
			j_sholio_clubism = {
				name = "藍月光",
				text = {
					"打出的{C:clubs}梅花{}被計分時，{X:legendary,C:white}^#1#{}倍率",
					"然後將{X:legendary,C:white}^倍率{}數值提升{X:legendary,C:white}+#2#{}",
				},
			},
			j_sholio_corvus = {
				name = "耐削王牢科 (v43-48)",
